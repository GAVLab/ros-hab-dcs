...
bool operator==(const ::sensor_msgs_ext::set_axis_homeResponse_<ContainerAllocator1> & lhs, const ::sensor_msgs_ext::set_axis_homeResponse_<ContainerAllocator2> & rhs)
{
...
struct Definition< ::sensor_msgs_ext::set_axis_homeResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "bool success        # Indicates if the home position was set successfully.\n"
...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_msgs_ext::set_axis_homeResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
