...
class gnss_track(genpy.Message):
  _md5sum = "a14fcd5bdfa03784750802994cedd83c"
...
float64 velocity                        # The scalar velocity of the track, [m/s]"""
  ...
  __slots__ = ['reference','heading','velocity']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B2d().pack(_x.reference, _x.heading, _x.velocity))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.reference, _x.heading, _x.velocity,) = _get_struct_B2d().unpack(str[start:end])
      return self
