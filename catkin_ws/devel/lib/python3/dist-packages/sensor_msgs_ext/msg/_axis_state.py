...
"""autogenerated by genpy from sensor_msgs_ext/axis_state.msg. Do not edit."""
import codecs
import sys
...
class axis_state(genpy.Message):
  _md5sum = "fac91d40217087ed5dbc79c40ec194e4"
  _type = "sensor_msgs_ext/axis_state"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Reports the instantaneous state of an axis.
...
float64 acceleration        # The current acceleration of the axis [rad/s^2]"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(axis_state, self).__init__(*args, **kwds)
