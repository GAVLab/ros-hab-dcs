...
(cl:defmethod cl:initialize-instance :after ((m <acceleration>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'acceleration)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_msgs_ext-msg:<acceleration> is deprecated: use sensor_msgs_ext-msg:acceleration instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <acceleration>))
...
(cl:defmethod y-val ((m <acceleration>))
...
(cl:defmethod z-val ((m <acceleration>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<acceleration>)))
  ...
  (cl:format cl:nil "# A 3D measurement of linear acceleration.~%~%float64 x           # The linear acceleration in the X direction [m/s^2]~%float64 y           # The linear acceleration in the Y direction [m/s^2]~%float64 z           # The linear acceleration in the Z direction [m/s^2]~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'acceleration)))
  "Returns full string definition for message of type 'acceleration"
  (cl:format cl:nil "# A 3D measurement of linear acceleration.~%~%float64 x           # The linear acceleration in the X direction [m/s^2]~%float64 y           # The linear acceleration in the Y direction [m/s^2]~%float64 z           # The linear acceleration in the Z direction [m/s^2]~%~%"))
